...
public class Skidmarks : MonoBehaviour {
	...
	const float GROUND_OFFSET = 0.25f;  // Distance above surface in metres 0.02f
	const float MIN_DISTANCE = 0.8f; // Distance between skid texture sections in metres. Bigger = better performance, less smooth 0.25f
